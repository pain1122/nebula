<x-app-layout>
  <x-slot name="header"><h2 class="font-semibold text-xl">ایجاد تخصص</h2></x-slot>
  <div class="max-w-xl mx-auto p-4">
    <form method="POST" action="{{ route('admin.specialties.store') }}" class="bg-white p-4 rounded shadow space-y-3">
      @csrf
      <div>
